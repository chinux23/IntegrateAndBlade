...
#'hidden', present in WFaS and ported here
...
presentation_activate = 2501 #(presentation_activate, <presentation_no>), #Activates <presentation_no>. Fails if <presentation_no> is not running
...
spawn_missile                         = 3603 #(spawn_missile, <agent_no>, <position>, <speed_fixed_point>, <weapon_item_no>, <missile_item_no>, [<weapon_item_modifier>], [<missile_item_modifier>]), #Spawns a <missile_item_no> shot by <agent_no> with <weapon_item_no> at <position> with <speed_fixed_point>
