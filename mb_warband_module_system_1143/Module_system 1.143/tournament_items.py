...
["tpe_normal_boots",           "Tournament Greaves", [("bo_vae_t4_shoes",0)], itp_type_foot_armor |itp_civilian  | itp_attach_armature,0, 34 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(10)|difficulty(0) ,imodbits_cloth ],
["tpe_enhanced_boots",         "Tournament Greaves", [("bo_khe_t4_sandal",0)], itp_type_foot_armor |itp_civilian  | itp_attach_armature,0, 34 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(20)|difficulty(0) ,imodbits_cloth ],
["tpe_normal_spear",           "Tournament Spear", [("we_nor_spear_fjadraspjot",0)], itp_type_polearm| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear|itcf_overswing_polearm, 0 , weight(4.5)|difficulty(0)|spd_rtng(85) | weapon_length(120)|swing_damage(12 , blunt) | thrust_damage(18 ,  blunt),imodbits_polearm ],
["tpe_enhanced_spear",         "Tournament Spear", [("we_nor_spear_fjadraspjot",0)], itp_type_polearm| itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_spear|itcf_overswing_polearm, 0 , weight(4.5)|difficulty(0)|spd_rtng(85) | weapon_length(140)|swing_damage(18 , blunt) | thrust_damage(27 ,  blunt),imodbits_polearm ],
["tpe_normal_bow",             "Tournament Bow", [("we_nor_bow_hunting",0), ("hunting_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back, 0, weight(1.5)|spd_rtng(90) | shoot_speed(40) | thrust_damage(24, blunt),imodbits_bow ],
["tpe_enhanced_bow",           "Tournament Bow", [("we_nor_bow_hunting",0), ("hunting_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back, 0, weight(1.5)|spd_rtng(95) | shoot_speed(40) | thrust_damage(36, blunt),imodbits_bow ],
["tpe_normal_crossbow",        "Tournament Crossbow", [("we_rho_crossbow_light",0)], itp_type_crossbow |itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 0, weight(3)|spd_rtng(50)| shoot_speed(68) | thrust_damage(30,blunt)|max_ammo(1),imodbits_crossbow],
["tpe_enhanced_crossbow",      "Tournament Crossbow", [("we_rho_crossbow_light",0)], itp_type_crossbow |itp_primary|itp_two_handed ,itcf_shoot_crossbow|itcf_carry_crossbow_back, 0, weight(3)|spd_rtng(60)| shoot_speed(68) | thrust_damage(45,blunt)|max_ammo(1),imodbits_crossbow],
["tpe_normal_javelin",         "Tournament Javelins", [("we_sar_spear_javelin",0),("javelins_quiver_new", ixmesh_carry)], itp_type_thrown |itp_primary|itp_next_item_as_melee,itcf_throw_javelin|itcf_carry_quiver_back|itcf_show_holster_when_drawn, 0, weight(5) | spd_rtng(100) | shoot_speed(28) | thrust_damage(27, blunt) | max_ammo(50) | weapon_length(75), imodbits_thrown],
...
["tpe_normal_greatsword",      "Tournament Greatsword", [("practice_sword_heavy",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_greatsword, 21, weight(6.25)|spd_rtng(80)|weapon_length(110)|swing_damage(27,blunt)|thrust_damage(22,blunt),imodbits_none],
["tpe_enhanced_greatsword",    "Tournament Greatsword", [("practice_sword_heavy",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back, 670 , weight(2.75)|spd_rtng(90) | weapon_length(120)|swing_damage(40 , blunt) | thrust_damage(27 ,  blunt),imodbits_sword_high ],
...
["tpe_enhanced_lance",         "Tournament Lance", [("we_swa_spear_lance_jousting",0)], itp_couchable|itp_type_polearm|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_greatlance, 90 , weight(4.25)|spd_rtng(75) | weapon_length(240)|swing_damage(15 , blunt) | thrust_damage(23 ,  blunt),imodbits_none ],
...
# ["tpe_enhanced_horse_yellow",  "Tournament Warhorse", [("ho_sar_war_yellowroyal",0)], itp_type_horse, 0, 1224,abundance(50)|hit_points(165)|body_armor(40)|difficulty(0)|horse_speed(40)|horse_maneuver(41)|horse_charge(28)|horse_scale(110),imodbits_horse_basic|imodbit_champion],
# TPE+ 1.4 items
["tpe_normal_axe",             "Tournament Axe", [("we_swa_axe_hatchet",0)], itp_type_one_handed_wpn| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip, 24 , weight(2) | spd_rtng(90) | weapon_length(70) | swing_damage(20, blunt) | thrust_damage(0, pierce), imodbits_axe],
["tpe_enhanced_axe",           "Tournament Axe", [("we_swa_axe_hatchet",0)], itp_type_one_handed_wpn| itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip, 24 , weight(2) | spd_rtng(95) | weapon_length(75) | swing_damage(28, blunt) | thrust_damage(0, pierce), imodbits_axe],
...
["tpe_normal_throwing_axe",    "Tournament Throwing Axes", [("we_nor_axe_throw_bearded",0)], itp_type_thrown|itp_primary|itp_next_item_as_melee,itcf_throw_axe,100,weight(5)|abundance(100)|difficulty(0)|spd_rtng(85)|shoot_speed(18)|thrust_damage(30, blunt)|max_ammo(4)|weapon_length(53),imodbits_thrown_minus_heavy],
	["tpe_normal_throwing_axe_melee", "Tournament Throwing Axe", [("we_nor_axe_throw_bearded",0)], itp_type_one_handed_wpn|itp_primary|itp_bonus_against_shield,itc_scimitar,100,weight(1)|abundance(100)|difficulty(0)|spd_rtng(90)|weapon_length(53)|swing_damage(27, blunt),imodbits_thrown_minus_heavy],
["tpe_enhanced_throwing_axe",  "Tournament Throwing Axes", [("we_nor_axe_throw_bearded",0)], itp_type_thrown|itp_primary|itp_next_item_as_melee,itcf_throw_axe,100,weight(5)|abundance(100)|difficulty(0)|spd_rtng(85)|shoot_speed(18)|thrust_damage(42, blunt)|max_ammo(4)|weapon_length(53),imodbits_thrown_minus_heavy],
	["tpe_enhanced_throwing_axe_melee", "Tournament Throwing Axe", [("we_nor_axe_throw_bearded",0)], itp_type_one_handed_wpn|itp_primary|itp_bonus_against_shield,itc_scimitar,100,weight(1)|abundance(100)|difficulty(0)|spd_rtng(95)|weapon_length(63)|swing_damage(38, blunt),imodbits_thrown_minus_heavy],
